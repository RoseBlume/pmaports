...
# Various functions used in CI scripts and tests. This file is in
# .ci/lib/common.py and symlinked to .ci/testcases/common.py.
...
def parse_apkbuild_checksums(args, apkbuild_path):
    """
